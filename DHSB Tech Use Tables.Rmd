...
kable(table3b %>%
  ...
  group_rows("SN Used Most Often, N (%)", 1, 5) %>%
  group_rows("SN Use Frequency, N (%)", 6, 10) %>%
  ...
  group_rows("PM Use Frequency, N (%)", 11, 15) %>%
  ...
  group_rows("Frequency of Other Uses of Internet", 16, 20)

...
table3Names <- colnames(table3[, 3:ncol(table3)])
names(table3Names) <- paste0(
  colnames(table3[, 3:ncol(table3)]), " (N=", 
  table3[2, 3:ncol(table3)] %>% unlist(), ")"
)

table3 <- table3 %>%
  rename(!!table3Names) %>%
  filter(Header != "Number of Participants") %>%

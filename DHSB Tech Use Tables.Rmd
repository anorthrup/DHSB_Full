...
table3b <- bind_rows(
  table_ManyBinary_Lump(x = tech, n = 3, header = "Social Networking Apps",
    ...
    add_row(Variable = "General Social Networking (SN) Apps"),
  ...
  table_ManyBinary_Lump(tech, n = 3, header = "SN Activities",
                        variables = c(
                          ...
                          "S56_12G" = "Share links, other media",
                          ...
                          "S56_12L" = "Create or maintain alternate profiles",
                          "S56_12M" = "Support LGBTQ groups/causes",
                          "S56_12N" = "Search hormone therapies",
                          "S56_12O" = "Search gender surgeries/procedures",
                          "S56_12P" = "Search HIV information",
                          "S56_12Q" = "Play games",
                          "S56_12R" = "Other"
                        )),
  table_ManyBinary_Lump(tech, n = 3, header = "Who Do You Communicate With on SNs",
                        variables = c(
                          "S56_14A" = "Parents",
  ...
  table_ManyBinary_Lump(tech, n = 3, header = "What Do You Communicate About on SNs",
                        variables = c(
...
kable(table3b %>%
  ...
  group_rows("Who Do You Communicate With on SNs", 21, 25) %>%
  group_rows("What Do You Communicate About on SNs", 26, 30)
```

...
kable(table1 %>%
  ...
  group_rows(table1Index$Header[1], table1Index$Start[1], table1Index$End[1]) %>%
  group_rows(table1Index$Header[2], table1Index$Start[2], table1Index$End[2]) %>%
  group_rows(table1Index$Header[3], table1Index$Start[3], table1Index$End[3]) %>%
  group_rows(table1Index$Header[4], table1Index$Start[4], table1Index$End[4]) %>%
  group_rows(table1Index$Header[5], table1Index$Start[5], table1Index$End[5]) %>%
  group_rows(table1Index$Header[6], table1Index$Start[6], table1Index$End[6]) %>%
  group_rows(table1Index$Header[7], table1Index$Start[7], table1Index$End[7]) %>%
  group_rows(table1Index$Header[8], table1Index$Start[8], table1Index$End[8]) %>%
  group_rows(table1Index$Header[9], table1Index$Start[9], table1Index$End[9])
```
Footnotes:  
...
kable(table2 %>%
  ...
  kable_styling(bootstrap_options = c("striped", "condensed")) %>%
  group_rows(table2Index$Header[1], table2Index$Start[1], table2Index$End[1]) %>%
  group_rows(table2Index$Header[2], table2Index$Start[2], table2Index$End[2]) %>%
  group_rows(table2Index$Header[3], table2Index$Start[3], table2Index$End[3]) %>%
  group_rows(table2Index$Header[4], table2Index$Start[4], table2Index$End[4]) %>%
  group_rows(table2Index$Header[5], table2Index$Start[5], table2Index$End[5]) %>%
  group_rows(table2Index$Header[6], table2Index$Start[6], table2Index$End[6]) %>%
  group_rows(table2Index$Header[7], table2Index$Start[7], table2Index$End[7]) %>%
  group_rows(table2Index$Header[8], table2Index$Start[8], table2Index$End[8]) %>%
  group_rows(table2Index$Header[9], table2Index$Start[9], table2Index$End[9]) %>%
  group_rows(table2Index$Header[10], table2Index$Start[10], table2Index$End[10]) %>%
  group_rows(table2Index$Header[11], table2Index$Start[11], table2Index$End[11]) %>%
  group_rows(table2Index$Header[12], table2Index$Start[12], table2Index$End[12]) %>%
  group_rows(table2Index$Header[13], table2Index$Start[13], table2Index$End[13]) %>%
  group_rows(table2Index$Header[14], table2Index$Start[14], table2Index$End[14])
```

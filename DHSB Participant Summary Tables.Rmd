...
table2 <- bind_rows(
  ...
  table_Continuous(demo, variable = "MTUEX_RC",
                   ...
                   header = "Media and Technology Use and Attitudes Subscales, Mean (SD)"),
  #> Text Messaging
  ...
  table_Continuous(demo, variable = "MTUSNX10_RC",
  ...
  table_Continuous(demo, variable = "MTUAX02_RC",
  ...
  table_Continuous(demo, variable = "MTUAX07_RC",

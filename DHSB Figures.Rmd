...
plotCat(hsCat %>%
          filter(Timeframe == "Last 6 Mo"),
        fillVar = "Timeframe", facetCVar = "`Health Category`",
        title = "Figure 1. Proportion of Respondents Searching Internet for Health Information",
...
plotSum(snSum %>%
        ...
        title = "Figure 2. Communications and Social Network Activity Among Respondents",
